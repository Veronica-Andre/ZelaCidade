...
const criarBanco = async() => {
    ...
    await db.exec(`
        CREATE TABLE IF NOT EXISTS incidentes(
            ...
            hora_registro TEXT,            -- Horário em que foi registrado o problema
            status_resolucao TEXT DEFAULT 'Pendente',
            --Se não avisarem o status, o banco define automaticamente como 'Pendente"
        ...
        //              SELECIONE a CONTAGEM DE TUDO(*) e dê o apelido de 'total', vindo Da tabela 'incidentes'
    ...
    console.log(resultadoFinal)  
        ...
        return db; //A função 'criarBanco' agora entrega a "chave" do banco de dados
